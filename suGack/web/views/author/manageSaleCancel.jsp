			...
			<div class="inner">
				...
				<section id="contents">
					...
					<div class="manageSaleContents" align="center">
						<br>
						<p>취소 날짜 조회 날짜로 검색 api 찾아서 하기</p>
					...
					<div class="manageButton">
						<table style="height:100%;">
							<tr align="center">
								<td width="150px;min-width:150px;">취소 처리</td>
								<td><button style="width:120px;">취소 전 처리</button></td>
								<td><button style="width:120px;">취소 중 처리</button></td>
								<td><button style="width:120px;">취소 완료 처리</button></td>
								<td><button style="width:120px;">취소 거절 처리</button></td>
							</tr>
						</table>
					</div>
